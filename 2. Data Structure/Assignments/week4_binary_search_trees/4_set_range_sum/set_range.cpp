...
void big_rotation(Vertex *v)
{
    ...
    {
        // Zig-zig right, �̥����l�𲾨�root
        small_rotation(v->parent);
        small_rotation(v);
    }
    else if (v->parent->right == v && v->parent->parent->right == v->parent)
    {
        // Zig-zig left, �̥k���l�𲾨�root
        small_rotation(v->parent);
        small_rotation(v);
    }
    else
...
Vertex *find(Vertex *&root, int key)
{
    ...
    while (v != NULL)
    {
        ...
        // �n�䪺key����e��vertex�٤j, �h����vertex���k�l���
        if (v->key < key)
        {
            v = v->right;
        }
    ...
    // �p�Gkey�S�����, �B�L���Ȥ�Ҧ�vertex���j, return NULL
    // �p�Gkey�S�����, �L���ȨèS����Ҧ�vertex�٤j, return ��L�j�ε���L��vertex (key���e�@��vertex)
    // �p�Gkey�����, return��vertex
    if (next != NULL)
    {
        //cout << "next: " << next->key << endl;
        // �p�G�����, ��key��vertex���ɨ�root, �S���h��̫�@�ӧ�M��vertex���ɨ�root
        splay(root, next);
    }
    else
        splay(root, last);
...
void erase(int x)
{
    ...
    if (found(x))
    {
        // �p�G�����key, ��key�ثe���ɬ�root, �N����child��parent�����VNULL
