...
private:
    ...
    void SiftDown(int i)
    {
        ...
        if (l < threads.size())
        {
            if ((threads[l].finish_time < threads[minIndex].finish_time) || (threads[l].finish_time == threads[minIndex].finish_time && threads[l].threadIndex < threads[minIndex].threadIndex))
            {
                minIndex = l;
            }
        }
        ...
        if (r < threads.size())
        {
            if ((threads[r].finish_time < threads[minIndex].finish_time) || (threads[r].finish_time == threads[minIndex].finish_time && threads[r].threadIndex < threads[minIndex].threadIndex))
            {
                minIndex = r;
            }
        }
